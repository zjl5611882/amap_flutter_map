...
- (void)setMarkerData:(NSDictionary *)markerData{
    ...
    NSString *descString = [NSString stringWithFormat:@"￥%@/度",markerData[@"desc"]];
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:descString];
    NSRange range1 = [descString rangeOfString:@"￥"];
    [attributedString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:8] range:range1];
    NSRange range2 = [descString rangeOfString:@"/度"];
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"%@",markerData[@"num"]];
